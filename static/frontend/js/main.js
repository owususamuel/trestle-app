$(document).ready(function () {
  ...
  $("#camera-upload").click(function () {
    ...
    Promise.all([
        faceapi.nets.tinyFaceDetector.loadFromUri("../static/frontend/js/models"),
        faceapi.nets.faceLandmark68Net.loadFromUri("../static/frontend/js/models"),
        faceapi.nets.faceRecognitionNet.loadFromUri("../static/frontend/js/models"),
        faceapi.nets.faceExpressionNet.loadFromUri("../static/frontend/js/models"),
        faceapi.nets.ageGenderNet.loadFromUri("../static/frontend/js/models")
    ]).then(startVideo);
...
video.addEventListener("playing", () => {
  ...
  $("#reset-camera").click(function () {
    ...
    $("#camera-upload").show()
    $("#image").removeAttr("style")
    default_image = "<img src='/static/frontend/images/placeholder.png' class='z-depth-2 img-fluid rounded' alt='placeholder'>"
  ...
  $ajaxPost = function (form_data) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        var content = "There are "
        content += response["faces"]
        content +=  " persons in the Picture "
        $("#faces").html(content)
      },
